...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.logBox = QtWidgets.QCheckBox(Dialog)
        self.logBox.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.logBox.setObjectName("logBox")
        self.gridLayout.addWidget(self.logBox, 7, 0, 1, 1)
        self.logCombo = QtWidgets.QComboBox(Dialog)
        self.logCombo.setObjectName("logCombo")
        self.logCombo.addItem("")
        self.logCombo.addItem("")
        self.gridLayout.addWidget(self.logCombo, 7, 2, 1, 1)
        self.logLabel = QtWidgets.QLabel(Dialog)
        self.logLabel.setObjectName("logLabel")
        self.gridLayout.addWidget(self.logLabel, 7, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.logBox.setText(_translate("Dialog", "Take logs"))
        self.logCombo.setItemText(0, _translate("Dialog", "Size and shape"))
        self.logCombo.setItemText(1, _translate("Dialog", "All"))
        self.logLabel.setText(_translate("Dialog", "Measurements:"))
